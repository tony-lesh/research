...
<body class="bg-dark">
    ...
    <main id="main">
        ...
        <div class="align-self-center w-100">
            <h4 class="text-white text-center"><b>Create New Account</b></h4>
            <div id="login-center" class="bg-dark row justify-content-center">
                <div class="card col-md-4">
                    <div class="card-body">
                        <form id="vsr-frm" method="POST" action="">
                            <div class="form-group">
                                <label for="ClientId" class="control-label text-dark">ID#:</label>
                            ...
                            <button type="submit" class="btn btn-primary" id='button' name="register">Create Account</button>
