...
class allBills
{
	...
	// Table name
	public $TableName = 'allBills.php';

	// Page object name
	public $PageObjName = "allBills";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'allBills.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "allBills", $url, "", "allBills", TRUE);
		$this->Heading = $Language->TablePhrase("allBills", "TblCaption"); 
	}
} // End class
?>