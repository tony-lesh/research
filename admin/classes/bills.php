...
class bills
{
	...
	// Table name
	public $TableName = 'bills.php';

	// Page object name
	public $PageObjName = "bills";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'bills.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "bills", $url, "", "bills", TRUE);
		$this->Heading = $Language->TablePhrase("bills", "TblCaption"); 
	}
} // End class
?>