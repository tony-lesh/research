...
class invoice
{
	...
	// Table name
	public $TableName = 'invoice.php';

	// Page object name
	public $PageObjName = "invoice";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'invoice.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "invoice", $url, "", "invoice", TRUE);
		$this->Heading = $Language->TablePhrase("invoice", "TblCaption"); 
	}
} // End class
?>