...
class ackupFiles
{
	...
	// Table name
	public $TableName = 'ackupFiles.php';

	// Page object name
	public $PageObjName = "ackupFiles";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'ackupFiles.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "ackupFiles", $url, "", "ackupFiles", TRUE);
		$this->Heading = $Language->TablePhrase("ackupFiles", "TblCaption"); 
	}
} // End class
?>