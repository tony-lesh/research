 ...
 * Page class
 */
class property_copy_edit extends property_copy
{
	...
	// Page object name
	public $PageObjName = "property_copy_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// ChargeableFee
			$this->ChargeableFee->setDbValueDef($rsnew, $this->ChargeableFee->CurrentValue, NULL, $this->ChargeableFee->ReadOnly);

			// BalanceBF
			$this->BalanceBF->setDbValueDef($rsnew, $this->BalanceBF->CurrentValue, NULL, $this->BalanceBF->ReadOnly);

			// AmountPayable
			$this->AmountPayable->setDbValueDef($rsnew, $this->AmountPayable->CurrentValue, NULL, $this->AmountPayable->ReadOnly);

			// AmountPaid
			$this->AmountPaid->setDbValueDef($rsnew, $this->AmountPaid->CurrentValue, NULL, $this->AmountPaid->ReadOnly);

			// CurrentBalance
			$this->CurrentBalance->setDbValueDef($rsnew, $this->CurrentBalance->CurrentValue, NULL, $this->CurrentBalance->ReadOnly);
