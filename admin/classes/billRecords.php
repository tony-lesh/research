...
class billRecords
{
	...
	// Table name
	public $TableName = 'billRecords.php';

	// Page object name
	public $PageObjName = "billRecords";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'billRecords.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "billRecords", $url, "", "billRecords", TRUE);
		$this->Heading = $Language->TablePhrase("billRecords", "TblCaption"); 
	}
} // End class
?>