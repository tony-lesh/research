 ...
 * Page class
 */
class property_revenu_preview extends property_revenu
{
	...
	// Page object name
	public $PageObjName = "property_revenu_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'property_revenu');
			if ($Security->isLoggedIn())
