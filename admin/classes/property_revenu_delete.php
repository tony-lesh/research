 ...
 * Page class
 */
class property_revenu_delete extends property_revenu
{
	...
	// Page object name
	public $PageObjName = "property_revenu_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("property_revenulist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("property_revenulist.php"); // Return to list
			}
		}
	}
