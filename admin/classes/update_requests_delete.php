 ...
 * Page class
 */
class update_requests_delete extends update_requests
{
	...
	// Page object name
	public $PageObjName = "update_requests_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("update_requestslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("update_requestslist.php"); // Return to list
			}
		}
	}
