 ...
 * Page class
 */
class update_requests_add extends update_requests
{
	...
	// Page object name
	public $PageObjName = "update_requests_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("update_requestslist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "update_requestsview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->NewClientIdentity->CurrentValue = NULL;
		$this->NewClientIdentity->OldValue = $this->NewClientIdentity->CurrentValue;
		$this->NewClientName->CurrentValue = NULL;
		$this->NewClientName->OldValue = $this->NewClientName->CurrentValue;
		$this->NewAccountType->CurrentValue = NULL;
		$this->NewAccountType->OldValue = $this->NewAccountType->CurrentValue;
		$this->NewMobileNumber->CurrentValue = NULL;
		$this->NewMobileNumber->OldValue = $this->NewMobileNumber->CurrentValue;
		$this->NewEmail->CurrentValue = NULL;
		$this->NewEmail->OldValue = $this->NewEmail->CurrentValue;
		$this->NewAdditionalInformation->CurrentValue = NULL;
		$this->NewAdditionalInformation->OldValue = $this->NewAdditionalInformation->CurrentValue;
	...
	protected function newRow()
	{
		...
		$row['NewClientIdentity'] = $this->NewClientIdentity->CurrentValue;
		$row['NewClientName'] = $this->NewClientName->CurrentValue;
		$row['NewAccountType'] = $this->NewAccountType->CurrentValue;
		$row['NewMobileNumber'] = $this->NewMobileNumber->CurrentValue;
		$row['NewEmail'] = $this->NewEmail->CurrentValue;
		$row['NewAdditionalInformation'] = $this->NewAdditionalInformation->CurrentValue;
	...
	protected function addRow($rsold = NULL)
	{
		...
		// NewClientIdentity
		$this->NewClientIdentity->setDbValueDef($rsnew, $this->NewClientIdentity->CurrentValue, NULL, FALSE);

		// NewClientName
		$this->NewClientName->setDbValueDef($rsnew, $this->NewClientName->CurrentValue, NULL, FALSE);

		// NewAccountType
		$this->NewAccountType->setDbValueDef($rsnew, $this->NewAccountType->CurrentValue, NULL, FALSE);

		// NewMobileNumber
		$this->NewMobileNumber->setDbValueDef($rsnew, $this->NewMobileNumber->CurrentValue, NULL, FALSE);

		// NewEmail
		$this->NewEmail->setDbValueDef($rsnew, $this->NewEmail->CurrentValue, NULL, FALSE);

		// NewAdditionalInformation
		$this->NewAdditionalInformation->setDbValueDef($rsnew, $this->NewAdditionalInformation->CurrentValue, NULL, FALSE);
