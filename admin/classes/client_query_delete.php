 ...
 * Page class
 */
class client_query_delete extends client_query
{
	...
	// Page object name
	public $PageObjName = "client_query_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("client_querylist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("client_querylist.php"); // Return to list
			}
		}
	}
