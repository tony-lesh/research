 ...
 * Page class
 */
class property_type_add extends property_type
{
	...
	// Page object name
	public $PageObjName = "property_type_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("PropertyTypeCode") !== NULL) {
				...
				$this->setKey("PropertyTypeCode", $this->PropertyTypeCode->CurrentValue); // Set up key
			} else {
				$this->setKey("PropertyTypeCode", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("property_typelist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "property_typeview.php")
