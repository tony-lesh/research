...
class index
{
	...
	public function run()
	{
		...
		if ($Security->allowList(CurrentProjectID() . 'charge_group'))
			$this->terminate("charge_grouplist.php"); // Exit and go to default page
		...
		if ($Security->allowList(CurrentProjectID() . 'billsPrint.php'))
			$this->terminate("billsPrint.php");
		if ($Security->allowList(CurrentProjectID() . 'system_settings'))
			$this->terminate("system_settingslist.php");
		if ($Security->allowList(CurrentProjectID() . 'update_requests'))
			$this->terminate("update_requestslist.php");
		if ($Security->allowList(CurrentProjectID() . 'reportview'))
			$this->terminate("reportviewlist.php");
		if ($Security->allowList(CurrentProjectID() . 'Rates_Report'))
			$this->terminate("Rates_Reportctb.php");
		if ($Security->allowList(CurrentProjectID() . 'client_query'))
			$this->terminate("client_querylist.php");
		if ($Security->allowList(CurrentProjectID() . 'bills.php'))
			$this->terminate("bills.php");
		if ($Security->allowList(CurrentProjectID() . 'billRecords.php'))
			$this->terminate("billRecords.php");
		if ($Security->allowList(CurrentProjectID() . 'allBills.php'))
			$this->terminate("allBills.php");
		if ($Security->allowList(CurrentProjectID() . 'backup.php'))
			$this->terminate("backup.php");
		if ($Security->allowList(CurrentProjectID() . 'backupFiles.php'))
			$this->terminate("backupFiles.php");
		if ($Security->allowList(CurrentProjectID() . 'billing_period'))
