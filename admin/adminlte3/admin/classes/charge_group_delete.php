 ...
 * Page class
 */
class charge_group_delete extends charge_group
{
	...
	// Page object name
	public $PageObjName = "charge_group_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("charge_grouplist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("charge_grouplist.php"); // Return to list
			}
		}
	}
