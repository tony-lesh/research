...
class backupFiles
{
	...
	// Table name
	public $TableName = 'backupFiles.php';

	// Page object name
	public $PageObjName = "backupFiles";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'backupFiles.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "backupFiles", $url, "", "backupFiles", TRUE);
		$this->Heading = $Language->TablePhrase("backupFiles", "TblCaption"); 
	}
} // End class
?>