 ...
 * Page class
 */
class property_copy_delete extends property_copy
{
	...
	// Page object name
	public $PageObjName = "property_copy_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("property_copylist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("property_copylist.php"); // Return to list
			}
		}
	}
