...
class billsPrint
{
	...
	// Table name
	public $TableName = 'billsPrint.php';

	// Page object name
	public $PageObjName = "billsPrint";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'billsPrint.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "billsPrint", $url, "", "billsPrint", TRUE);
		$this->Heading = $Language->TablePhrase("billsPrint", "TblCaption"); 
	}
} // End class
?>