...
class backup
{
	...
	// Table name
	public $TableName = 'backup.php';

	// Page object name
	public $PageObjName = "backup";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'backup.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "backup", $url, "", "backup", TRUE);
		$this->Heading = $Language->TablePhrase("backup", "TblCaption"); 
	}
} // End class
?>