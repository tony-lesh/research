...
$content .= '
		<tr><td>'.$row['PropertyId'].'</td><td>'.$row['Property'].'</td><td>PUL '.$row['ChargeableFee'].'</td><td>PUL '.$row['BalanceBF'].'</td><td>PUL '.$row['AmountPayable'].'</td><td>PUL '.$row['AmountPaid'].'</td><td>PUL '.$row['CurrentBalance'].'</td></tr>
		';
	}
}else{
$content .= '
